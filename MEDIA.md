...
- Publisher: [Brooklyn Point / Extell](https://brooklynpointnyc.com/).
- Production context: [SERHANT.'s 2021 letter](https://serhantannualletter2021.com/)
  documents the commercial. The project's own public player supplies the media.
- Background: the original silent, 19.32-second project teaser, 1900 × 1080,
  preserved without re-encoding. Mobile rendition: 960 pixels wide.
- Full film: streamed from the original publisher, with native viewer controls.
  The original site includes its captions.
- Poster: a frame from that project's published full film.
- Files: assets/campaigns/brooklyn.mp4, brooklyn-mobile.mp4, brooklyn.jpg.
- Original teaser: https://extell.nyc3.digitaloceanspaces.com/brooklynpoint/intro-teaser.mp4?version=2
- Original full film: https://extell.nyc3.digitaloceanspaces.com/brooklynpoint/intro-film.mp4?version=2

## Development marketing montage

- Publisher: [SERHANT. Development Marketing](https://serhant.com/developers).
- Original silent 13.16-second montage, 1920 × 828, preserved without
  re-encoding. It is an overview of published development creative.
- Used in the campaign gallery and the media/outreach phase. It is not labeled
  as a single named development campaign.
- Files: assets/campaigns/lifestyle.mp4, lifestyle-mobile.mp4, lifestyle.jpg.
- Original media: https://res.cloudinary.com/luxuryp/videos/f_mp4,vc_h264,w_1920,c_limit/t6ofnwdemxmiiubdbdzm/-a528-4722-9ab3-8be7494077b0-video-convertercom.mp4

## Planning, branding and sales footage

- Publisher: [SERHANT. New Development](https://serhant.com/new-development).
- Research: seconds 17–24; brand: 24–33; sales: 33–42.
- Silent presentation excerpts, encoded at the original 1920-pixel width,
  with 960-pixel mobile renditions and frame-derived posters.
- The selected intervals omit the opening historical inventory headline.
- Footage illustrates the proposed workflow; it is not presented as a recording
  of work already performed for Holland Park.
- Files: assets/campaigns/research.*, brand.*, sales.* and their mobile variants.
- Original media: https://res.cloudinary.com/luxuryp/videos/f_mp4,vc_h264,w_1920,c_limit/xjwd9qi9xhw39dev6mjt/newdevfilmfinal.mp4

## Production footage

- Publisher: [SERHANT. Studios](https://serhant.com/studios).
- Background excerpt: seconds 7–17 at the source's 1920-pixel width, silent,
  with a 960-pixel mobile rendition.
- The cinema offers the full original Studios reel on demand. It includes
  broader studio production and programming, not exclusively development work.
- Files: assets/campaigns/production.mp4, production-mobile.mp4, production.jpg.
- Original media: https://res.cloudinary.com/luxuryp/videos/f_mp4,vc_h264,w_1920,c_limit/b25ihlrfrilixkfu36co/about-studios-2.mp4
...
- [OUTFRONT case study](https://www.outfront.com/resources/ooh-case-studies/serhant-real-estate)
  documents the New York welcome campaign and displays the original photograph.
- Historical SERHANT. brokerage brand advertising, with 2021 source context;
  not a development-specific campaign or evidence of current placement.
- We do not repeat the vendor's attributed sales or potential-reach figures.
- Original 1440 × 810 photograph: assets/campaigns/billboard.jpg.
- Image source: https://images.contentstack.io/v3/assets/bltbeaed4aed52c223a/blt5815d54bb87909bd/68ba1613ef67495d7737b298/serhant-real-estate-hero-header.jpg
...
- Original source resolution is retained; no artificial upscaling is claimed.
- Backgrounds are silent, looped and lazy-loaded. Phones receive smaller files.
- Hidden tabs, off-screen videos, background documents and open cinema dialogs
  pause presentation footage. Reduced-motion and data-saver preferences begin
